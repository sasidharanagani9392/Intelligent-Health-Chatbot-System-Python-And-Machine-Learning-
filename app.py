...
Answer:
    ...
    model = ChatGoogleGenerativeAI(
        model="models/gemini-1.5-pro-latest", temperature=0.4, safety_settings=safety_settings
    )
...
def generate_medical_report(name, previous_questions=None, previous_responses=None):
    try:
        genai.configure(api_key=os.getenv("AIzaSyCAJNDwQzpGWnqEOt4XMb0-qzlhEJ3IzFk"))
